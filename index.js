...
const  uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.edfearx.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0`;
...
app.get('/message/:id', async (req, res) => {
  ...
  try {
    ...
    res.status(500).send('Error retrieving message: ' + err.message);
  }
});
